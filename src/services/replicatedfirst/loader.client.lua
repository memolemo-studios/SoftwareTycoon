warn("Software Tycoon client is now starting")
print([[Hi, welcome to the debugging bench of Software Tycoon!
If you encounter bugs or errors showed in this developer console (expect asset failed stuff)
Please contact me at Github or Twitter. :D]])
...
local service: ReplicatedFirst = script.Parent
